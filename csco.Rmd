...
## Monday Effect
Based on OLS with Newey-West SE using Monday dummy variable there is no evidence for Monday effect. 
```{r echo=FALSE, warning=FALSE}
cisco[, Weekday.Monday := weekdays(Date) == "Monday"]
...
## Time Periods
Based on the "Close price over time" chart there is a significant difference in price before and after March, 2000. According to [Market Crashes: The Dotcom Crash](the http://www.investopedia.com/features/crashes/crashes8.asp) article, The Nasdaq Composite lost 78% of its value as it fell from 5046.86 to 1114.11. 
```{r echo=FALSE, warning=FALSE}
...
3. Consider the first model. Interpret the β coefficient in words. What 
