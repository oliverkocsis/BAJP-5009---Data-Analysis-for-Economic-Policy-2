...
where RS is the return of your stock, RI is the return of nasdaq composite, si are seasonal dummies.
...
## β coefficient 
Consider the first model. Interpret the β coefficient in words. What economic/finance concept could you relate it to?

# Extra Credit: ARMA(2,2) 
For extra credit: repeat this with ARMA(2,2) and discuss stability of results.
## Autocorrelation Function
```{r echo=FALSE, warning=FALSE}
